...
完整参数与故障排查见 CLI 自身的 README：[GitHub](https://github.com/mx-space/core/tree/master/packages/mongo-pg-cli) · [npm](https://www.npmjs.com/package/@mx-space/mongo-pg-cli)。
