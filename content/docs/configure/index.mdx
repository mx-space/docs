...
<Cards>
  <Card title="环境变量参考" href="./environment">
    查看所有支持的环境变量及其说明
  </Card>
  <Card title="SEO 与站点优化" href="./seo">
    SEO 元数据、Sitemap、RSS、百度/Bing 推送
  </Card>
  <Card title="账号与安全" href="./account-security">
    所有者信息、API Token、Passkey、OAuth 绑定
  </Card>
  <Card title="图床与存储" href="./image-storage">
    S3 对象存储配置、CDN 加速、自定义存储路径
  </Card>
  <Card title="OAuth 2.0" href="./oauth">
    配置 GitHub、Google 等第三方登录
  </Card>
  <Card title="Algolia Search" href="./algolia">
    为站点添加 Algolia 站内搜索
  </Card>
  <Card title="Key 加密" href="./encryption">
    加密数据库中的敏感配置项
  </Card>
</Cards>
